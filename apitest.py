...
def applydata(listx):
		response = requests.get("https://rest.coinapi.io/v1/ohlcv/{}/history?period_id=5MIN&time_start=2019-04-26T00:00:00&limit=10000".format(listx),headers=parameters)
		print("{}".format(listx))
