...
global parameters
parameters = {"X-CoinAPI-Key":"A021099A-A249-43E5-8A12-A065A1BC7E0D"}
...
def main():
	response=requests.get("https://rest.coinapi.io/v1/symbols?filter_symbol_id=BITSTAMP",headers=parameters)
	binancelist=[]
